...
1. NEXTJS: npx create-next-app@latest (eslint and tailwind included)
2. added prettier (installed the dependency and tailwind plugin, created .prettierrc - basics from the docs + tw, created .prettierignore)
3. added husky
4. created public folder for images
...
2. How to prevent a form height from jumping when an error message occurs (when an input is empty)?
...
STYLES:\
Background-image
`bg-[url('/images/...')] bg-cover bg-indigo-950`

`className="relative -mb-16 ..."` ===> to move a section down above the next section.
